...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 1.00    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  #define MESH_MAX_X X_BED_SIZE - (MESH_INSET) + NOZZLE_TO_PROBE_OFFSET_X
  #define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET) + NOZZLE_TO_PROBE_OFFSET_Y
#endif
